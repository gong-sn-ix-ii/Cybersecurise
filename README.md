...
[![Cyber Toptalent](https://img.shields.io/badge/💰%20Thailand%20Cyber-Toptalent%20Grant-27C93F?style=for-the-badge)](https://www.nectec.or.th)
...
> 🏆 **โปรเจกต์นี้ได้รับเลือกเข้ารอบชิงชนะเลิศระดับประเทศ NSC 2024** (โครงการการแข่งขันพัฒนาโปรแกรมคอมพิวเตอร์แห่งประเทศไทย ครั้งที่ 26) และได้รับทุนสนับสนุน **Thailand Cyber Toptalent** จาก NECTEC & NSTDA
...
นอกจากนี้ยังประเมินความเสี่ยงของแต่ละแอปที่ติดตั้ง โดยดูจาก **Permission ที่ขอ** — แอปบางตัวขอเข้าถึง SMS, Contacts, และ Accessibility พร้อมกัน = ผิดปกติชัดเจน

### 3️⃣ Blacklist Lookup — เช็คเลขบัญชี / เบอร์โทร / ชื่อ
...
### 4️⃣ Cybersecurity Quiz — ฝึกภูมิคุ้มกันไซเบอร์
...
| 💰 **ทุนสนับสนุน** | Thailand Cyber Toptalent (ปลายปี 2023) |
